...
public class Remplir_stock  {
	
	public Remplir_stock() throws Exception   {
		initfull();
	}
	...
	public void initfull() throws Exception {
		...
		Label lb6=new Label("Quantité à ajoutée : ");
		...
		Button bt1 = new Button ("Remplir au stock");
		bt1.setMinWidth(100);
		bt1.setMinHeight(20);
		...
		v.setSpacing(13.0);
		v.getChildren().addAll(er_up,er,lb1,tf1, lb2,tf2, lb3,tf3, lb4,tf4, lb6,tf6, h);
		v.setLayoutY(100);
		v.setLayoutX(300);
